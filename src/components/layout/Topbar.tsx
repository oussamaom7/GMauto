...
export async function Topbar() {
  ...
  return (
    <header className="flex h-16 items-center gap-4 border-b border-zinc-200 bg-white/80 px-6 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/80">
      <form action="/stock" method="GET" className="relative max-w-md flex-1">
        <Search
          size={16}
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-zinc-200 px-3 py-1.5 text-sm text-zinc-600 dark:border-zinc-800 dark:text-zinc-300">
